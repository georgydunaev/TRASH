...
Lemma cng_commF  xe xi m0 m1 pi fi : (*with equality*)
...
+ simpl. 
apply ix.
Check IHfi (cng pi xi m1) m0 m1 xe x.
(* assert (ii : PeanoNat.Nat.eqb xe x = false ). admit.
rewrite (fun y => (IHfi (cng pi xi m1) m0 y xe x ii)).
